...
const SearchComponent = () => {
  ...
  return (
    <div className="relative">
      <div className="flex items-center px-4 py-2 bg-[#F3F9FB] rounded-md w-full h-12">
        ...
        <input
          ...
          className="bg-transparent outline-none w-[440px]"
        />
      </div>
...
const SearchBar = () => {
  ...
  <button className="flex items-center justify-center w-48 h-12 rounded-md bg-red-600">
    <div className="flex items-center justify-center h-6 w-6 text-white mr-2">
      <RxPerson />
    </div>
    <p className="text-white font-bold">Sign Up/Sign In</p>
  </button>
</div>
