...
import { Pagination } from "swiper/modules"; // Removed Navigation module
import "swiper/css";
...
const ImageSlider = () => {
  ...
  return (
    <div className="w-[1201px] h-[316px] mx-auto relative mt-4">
      <Swiper
        pagination={{
          clickable: true,
        }}
      ...
      >
        {images.map((image, index) => (
          <SwiperSlide key={index}>
            <div className="flex">
              {/* Left part with text */}
              <div className="w-1/2 bg-blue-950 flex flex-col items-start justify-center pl-20 rounded-l-lg  leading-8 ">
                <div>
                ...
                <div>
                  <h1 className="text-5xl font-extrabold mt-2 mb-2 text-[#ff3b30]">
                    pre-owned cars
                  </h1>
                </div>
                <div>
